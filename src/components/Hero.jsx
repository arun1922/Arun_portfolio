...
import heroVideo from '../assets/hero video/arunkumar-hero.mp4';
import heroPoster from '../assets/about/arunkumar-avatar.png';
    ...
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          <div 
            data-aos="fade-up"
            className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-black/60 border border-[#FF9900]/40 backdrop-blur-md mb-4 shadow-[0_0_20px_rgba(255,153,0,0.2)] hover:border-[#FF9900] transition-all duration-300"
          >
            ...
            <span className="text-white text-xs font-mono font-bold tracking-wider uppercase">
              AWS Certified Cloud & DevOps Specialist
            </span>
          </div>
