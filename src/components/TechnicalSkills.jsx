...
const SkillCard = ({ category, index }) => (
  ...
  >
    <h3 className="text-white text-lg font-black tracking-tight mb-6 pb-2 border-b border-white/10 uppercase flex items-center gap-2.5">
      {category.title === "AWS Cloud" && (
        <span className="w-7 h-7 inline-block shrink-0">
